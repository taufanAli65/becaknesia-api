...
import { createSchedule, getSchedules, getSchedule, updateSchedule, deleteSchedule, searchDriverSchedules } from "../controllers/schedule";
...
router.get("/driver/accepted", authenticated, authorize(userRoles.Driver), (req: Request, res: Response, next: NextFunction) => { searchDriverSchedules(req, res, next) });
